...
- [ ] **Phase 1: Core Logic** - Pure-function pipeline: IBAN extraction + MOD-97 validation, amount parsing, name heuristics, EPC payload assembly, field validation
...
**Success Criteria** (what must be TRUE):
  ...
  3. A QR code appears at minimum 200x200px after clicking Generate, and it scans correctly in ING, Rabobank, or ABN AMRO mobile apps to pre-fill a SEPA credit transfer with correct values
